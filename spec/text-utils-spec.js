...
describe('text utilities', function () {
  describe('.hasPairedCharacter(string)', () =>
    it('returns true when the string contains a surrogate pair, variation sequence, or combined character', function () {
      ...
      return expect(textUtils.hasPairedCharacter('\u0301\u0301')).toBe(false)
    })
  )

  describe('.isPairedCharacter(string, index)', () =>
    it('returns true when the index is the start of a high/low surrogate pair, variation sequence, or combined character', function () {
      ...
      return expect(textUtils.isPairedCharacter('ae\u0301c', 4)).toBe(false)
    })
  )

  describe('.isDoubleWidthCharacter(character)', () =>
    it('returns true when the character is either japanese, chinese or a full width form', function () {
      ...
      return expect(textUtils.isDoubleWidthCharacter('a')).toBe(false)
    })
  )

  describe('.isHalfWidthCharacter(character)', () =>
    it('returns true when the character is an half width form', function () {
      ...
      return expect(textUtils.isHalfWidthCharacter('B')).toBe(false)
    })
  )

  describe('.isKoreanCharacter(character)', () =>
    it('returns true when the character is a korean character', function () {
      ...
      return expect(textUtils.isKoreanCharacter('O')).toBe(false)
    })
  )

  return describe('.isWrapBoundary(previousCharacter, character)', () =>
    it('returns true when the character is CJK or when the previous character is a space/tab', function () {
      ...
      expect(textUtils.isWrapBoundary('\t', 'h')).toBe(true)
      return expect(textUtils.isWrapBoundary('a', 'h')).toBe(false)
    })
  )
})
